        ...
        <div class="container">
            <div class="about">
                <h2 class="about__title">
                    ...
                    >
                        <path d="M0 22.54H22V0.54H0V22.54Z" fill="url(#pattern3)" />
                        <defs>
                            <pattern
                                id="pattern3"
                ...
                <section class="about__section">
                    <p class="about__section__text">
                        Команда FriendsОnly создана небольшой группой специалистов, которые любят
                        своё дело и всегда заряжены на результат.
                    </p>
                    <p class="about__section__text">
...
.vacanсy__card__title {
    font-style: normal;
    font-weight: 600;
    font-size: 18px;
    line-height: 150%;
}
.vacanсy__card__responsibilities {
    margin-top: 36px;
}
.vacanсy__card__responsibilities__title {
...
.vacanсy__card__responsibilities__text {
    margin-top: 4px;
    opacity: 0.5;
    font-style: normal;
    font-weight: normal;
...
.vacanсy__card__qualification {
    margin-top: 20px;
}
.vacanсy__card__qualification__title {
    font-family: "SF Pro Display-Semibold";
    font-style: normal;
    font-weight: 500;
    font-size: 15px;
...
.vacanсy__card__qualification__text {
    margin-top: 4px;
    opacity: 0.5;
    font-style: normal;
    font-weight: normal;
