<template>
    <div>
        <Header />
        <transition-group>
            <div v-if="loading" key="first" class="containerOuter">
                <div class="container">
                    <div class="pre-item">
                    ...
                    <div class="loader-wrapper">
                        ...
                        >
                            ...
                            />
                            <path
                                d="M34 67C36.7614 67 39 64.7614 39 62C39 59.2386 36.7614 57 34 57V67ZM34 10C36.7614 10 39 7.76142 39 5C39 2.23858 36.7614 0 34 0V10ZM34 57C20.6628 57 10 46.3971 10 33.5H0C0 52.0832 15.3047 67 34 67V57ZM10 33.5C10 20.6029 20.6628 10 34 10V0C15.3047 0 0 14.9168 0 33.5H10Z"
                                fill="#E2E2E2"
                            />
                        </svg>
                    </div>
            ...
            <div v-else key="second" class="containerOuter">
                <router-link custom v-slot="{ navigate }" to="/desktop/news">
                    <div class="btn" @click="navigate">
                        ...
                        >
                            <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                                d="M5.42225 10.7334L0.238574 6.02334C-0.0795226 5.73431 -0.0795226 5.26569 0.238574 4.97666L5.42225 0.26658C5.74034 -0.0224534 6.25608 -0.0224534 6.57417 0.266581C6.89227 0.555614 6.89227 1.02423 6.57417 1.31326L1.96646 5.5L6.57417 9.68674C6.89227 9.97577 6.89227 10.4444 6.57417 10.7334C6.25608 11.0225 5.74034 11.0225 5.42225 10.7334Z"
                                fill="white"
                                fill-opacity="0.9"
                            />
                        </svg>
                ...
                <div class="container">
                                ...
                                <p class="views">
                                    ...
                                    >
                                        <g clip-path="url(#clip0)">
                                            <path
                                                d="M6.99991 5.09033C5.94672 5.09033 5.09082 5.94623 5.09082 6.99942C5.09082 8.05261 5.94672 8.9085 6.99991 8.9085C8.0531 8.9085 8.909 8.05261 8.909 6.99942C8.909 5.94623 8.05307 5.09033 6.99991 5.09033Z"
                                                fill="white"
                                            />
                                            <path
                                                d="M7.00002 2.22632C3.81818 2.22632 1.10092 4.20539 0 6.99905C1.10092 9.79268 3.81818 11.7718 7.00002 11.7718C10.185 11.7718 12.8991 9.79268 14 6.99905C12.8991 4.20539 10.185 2.22632 7.00002 2.22632ZM7.00002 10.1809C5.24365 10.1809 3.81818 8.75538 3.81818 6.99902C3.81818 5.24265 5.24365 3.81722 7.00002 3.81722C8.75638 3.81722 10.1818 5.24268 10.1818 6.99905C10.1818 8.75541 8.75638 10.1809 7.00002 10.1809Z"
                                                fill="white"
                                            />
                                        </g>
                                        <defs>
                                ...
                                <div class="like-blog">
                                    <p class="like">
                                        ...
                                        >
                                            <g clip-path="url(#clip0)">
                                                <path
                                                    d="M0.947917 12.4578H2.30208C2.82479 12.4578 3.25 12.0326 3.25 11.5098V5.28068C3.25 4.75797 2.82479 4.33276 2.30208 4.33276H0.947917C0.425208 4.33276 0 4.75797 0 5.28068V11.5098C0 12.0326 0.425208 12.4578 0.947917 12.4578Z"
                                                    fill="white"
                                                />
                                                <path
                                                    d="M6.92304 0.40625C6.38138 0.40625 6.11054 0.677083 6.11054 2.03125C6.11054 3.31825 4.86417 4.35392 4.0625 4.88746V11.5976C4.92971 11.999 6.66575 12.5938 9.36054 12.5938H10.2272C11.2835 12.5938 12.1826 11.8354 12.3614 10.7954L12.968 7.27458C13.1955 5.9475 12.1772 4.73958 10.8339 4.73958H8.27721C8.27721 4.73958 8.68346 3.92708 8.68346 2.57292C8.68346 0.947917 7.46471 0.40625 6.92304 0.40625Z"
                                                    fill="white"
                                                />
                                            </g>
                                            <defs>
                                    ...
                                    <p class="dislike">
                                        ...
                                        >
                                            <g clip-path="url(#clip0)">
                                                <path
                                                    d="M0.947917 0.542236H2.30208C2.82479 0.542236 3.25 0.967444 3.25 1.49015V7.71932C3.25 8.24203 2.82479 8.66724 2.30208 8.66724H0.947917C0.425208 8.66724 0 8.24203 0 7.71932V1.49015C0 0.967444 0.425208 0.542236 0.947917 0.542236Z"
                                                    fill="white"
                                                />
                                                <path
                                                    d="M6.92304 12.5938C6.38138 12.5938 6.11054 12.3229 6.11054 10.9688C6.11054 9.68175 4.86417 8.64608 4.0625 8.11254V1.40238C4.92971 1.001 6.66575 0.40625 9.36054 0.40625H10.2272C11.2835 0.40625 12.1826 1.16458 12.3614 2.20458L12.968 5.72542C13.1955 7.0525 12.1772 8.26042 10.8339 8.26042H8.27721C8.27721 8.26042 8.68346 9.07292 8.68346 10.4271C8.68346 12.0521 7.46471 12.5938 6.92304 12.5938Z"
                                                    fill="white"
                                                />
                                            </g>
                                            <defs>
                    ...
                    <div class="news-blog">
                        <div class="text-wrapper">
                            <p>
                                Одно из самых тяжелых испытаний для человека — смерть близкого.
                                Однако родственники героев нашего сегодняшнего материала столкнулись
                                с гораздо более страшной трагедией — их родные пропали без вести,
                                оставив близких в полнейшем неведении относительно их судьбы. Ушла
                                гулять с подругой и не вернулась, пропала из гостиничного номера,
                                исчез по дороге в художественную школу — эти жуткие формулировки
                                стали последними воспоминаниями для тех, чьи родные бесследно
                                исчезли, не оставив никаких следов, улик и тени надежды на то, что
                                они когда-нибудь вернутся домой. Долгие месяцы и даже годы поисков,
                                привлечение сил полиции и волонтеров, отчаянное желание узнать хоть
                                что-то о судьбе своих родных — эти дела о пропавших не сдвинулись с
                                мертвой точки, несмотря на колоссальные усилия всех участников
                                расследования. Однако в сердцах тех, кто ждет их дома, все еще жива
                                надежда на встречу.
                            </p>
                        </div>
                        ...
                        <div class="text-wrapper">
                            ...
                            <p class="blog-text">
                                8-летняя Николь Луиза Морен 30 июля 1985 года находилась в своем
                                доме в Торонто вместе с матерью. Семья жила в престижном районе
                                города Этобико, а их многоквартирный жилой комплекс с бассейном,
                                тренажерным залом, игровыми комнатами и охраняемой территорией
                                считался абсолютно безопасным.
                            </p>
                        </div>
                        <div class="img-wrapper">
                        ...
                        <div class="text-wrapper">
                            <p class="blog-text">
                                Утром Николь сообщила маме, что хочет пойти к бассейну вместе со
                                своей приятельницей, также проживающей в этом доме, и женщина
                                согласилась — родители девочки часто отпускали ее гулять на
                                территории здания, будучи уверенными в том, что там не случится
                                ничего плохого. Перед выходом Николь из квартиры в домофон позвонила
                                ее подруга Морен и сообщила, что ждет в холле дома — путь до
                                вестибюля составлял около трех минут, включая дорогу до лифта и
                                спуск вниз. Примерно в 11 часов утра девочка вышла из квартиры и
...
.btn {
    ...
    background: linear-gradient(180deg, rgba(0, 0, 0, 0.76) 0%, rgba(0, 0, 0, 0.95) 100%);
}
.btn > p {
    margin-left: 10px;
}
